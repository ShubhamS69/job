 ...
 */
  ...
  ?>
    ...
    <footer class="ftco-footer ftco-section" style="background-color: #006241">
      <div class="container">
        <div class="row mb-5">
        	<div class="col-md">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Kharghar</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">9821826721</span></a></li>
	                <li><a href="itsourcecode.com"><span class="icon icon-envelope"></span>questionus@gmail.com<span class="text"></span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
