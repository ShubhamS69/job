    ...
    <div class="hero-wrap js-fullheight" style="background-color: #006241">
    ...
    <section class="ftco-section services-section" style="background-color: #ffff">
      <div class="container">
    ...
    <section class="ftco-section ftco-counter" style="background-color: #ffff">
      <div class="container">
    ...
    <section class="ftco-section" style="background-color: #ffff">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
    ...
    <section class="ftco-section testimony-section" style="background-color: #ffff">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
